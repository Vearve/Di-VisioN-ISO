...
class ToolboxTalk(models.Model):
    ...
    attendee_employees = models.ManyToManyField('Employee', blank=True, related_name='toolbox_attendance')
    attendees = models.TextField(blank=True, help_text='Additional attendees not in the employee register (contractors, visitors, etc.)')
