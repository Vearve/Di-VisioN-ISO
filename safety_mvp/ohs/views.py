...
from .checklist_config import CHECKLIST_STEP_MAP
from .forms import (
...
def export_to_pdf(request, module_name):
    ...
    try:
        if module_name == 'incidents':
            ...
            buffer = pdf_gen.generate_checklists_report(data, site_name, step_map=CHECKLIST_STEP_MAP)
...
def checklists_page(request):
    ...
    checklist_step_map = CHECKLIST_STEP_MAP
