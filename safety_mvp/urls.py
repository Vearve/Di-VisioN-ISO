...
urlpatterns = [
    ...
    path('health/', views.safe_root, name='health'),
    ...
    path('app/monthly-health-reports/autofill/', views.monthly_report_autofill, name='monthly_report_autofill'),
    path('app/ems/aspects/', views.ems_aspects_page, name='ems_aspects_page'),
    path('app/ems/waste/', views.ems_waste_page, name='ems_waste_page'),
    path('app/ems/spills/', views.ems_spills_page, name='ems_spills_page'),
    path('app/ems/objectives/', views.ems_objectives_page, name='ems_objectives_page'),
    path('app/ems/energy/', views.ems_energy_page, name='ems_energy_page'),
